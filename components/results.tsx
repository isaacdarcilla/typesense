        ...
        >
          <div className="flex flex-col justify-between p-4 leading-normal">
            ...
            <div className="flex justify-between items-center">
              <h5
                ...
                dangerouslySetInnerHTML={{
                  __html:
                    result.highlight?.title?.snippet || result.document.title,
                }}
              />
              <Chip
                variant="shadow"
            ...
            <div className="flex justify-start items-center gap-1 my-2 text-gray-500">
              <small className="border-2 px-1 font-bold">
                {result.document.certification}
              </small>
            ...
            <div className="flex flex-col items-start mt-3 gap-1 text-neutral-600">
              ...
              <a
                className="text-tiny hover:text-blue-500"
                href={result.document.homepage}
                target="_blank"
              >

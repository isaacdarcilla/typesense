...
export default function Home() {
	...
	const handleSearch = (query: string) => {
		...
		typesense.collections(process.env.NEXT_PUBLIC_TYPESENSE_COLLECTION_NAME as string)
			.documents()
			.search({ q: query, query_by: 'title,tagline,overview', limit: 250, sort_by: 'release_date:desc' })
		...
		<section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
			<div className="inline-block max-w-lg text-center justify-center">
				...
				<div className="flex items-center gap-1">
					...
					<a href="https://typesense.org" target="_blank" rel="noopener" title="Movie">
						<Image width={100} height={120} alt="Image"
				...
				{!searchResults && (
					<>
						...
						<p className="-mt-3 text-center mx-auto text-md text-gray-500">
							Search movies... Try <Code onClick={() => {
								handleSearch('Inception')
							}} className="text-blue-600 cursor-pointer">Inception</Code>
						</p>
					</>
				)}
			</div>
